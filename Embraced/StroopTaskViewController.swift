//
//  StroopTaskViewController.swift
//  Embraced
//
...
class StroopTaskViewController: ActiveStepViewController {
...
//        self.performSegue(withIdentifier: "moveToInstructions2", sender: nil)
        let vc = StroopInstructions2ViewController()
...
extension StroopTaskViewController: AVAudioRecorderDelegate {
