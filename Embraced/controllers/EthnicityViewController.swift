...
//  Embraced
//
//  Created by Domonique Dixon on 7/5/16.
//  Copyright © 2016 Domonique Dixon. All rights reserved.
//

import UIKit

class EthnicityViewController: FrontViewController {
...
//        print(jsonObject)
        ...
        let VC1 = self.storyboard!.instantiateViewControllerWithIdentifier("MartialStatusViewController") as! MartialStatusViewController
