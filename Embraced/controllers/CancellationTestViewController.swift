...
class CancellationTestViewController: FrontViewController {
    ...
    override func viewDidLoad() {
        ...
        let url = NSURL (string: "http://girlscouts.harryatwal.com/cancellationTest.php");
    ...
    @IBAction func next(sender: AnyObject) {
        ...
        let VC1 = self.storyboard!.instantiateViewControllerWithIdentifier("EyeTestViewController") as! EyeTestViewController
