//
//  StroopPreTask3ViewController.swift
//  Embraced
//
...
class StroopPreTask3ViewController: ActiveStepViewController, AVPlayerViewControllerDelegate {
...
//        self.performSegue(withIdentifier: "moveToInstructions4", sender: nil)
        let vc = StroopInstructions4ViewController()
